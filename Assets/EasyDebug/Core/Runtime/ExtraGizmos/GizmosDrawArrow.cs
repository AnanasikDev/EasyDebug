...
{
    public static void ForGizmo(Vector3 pos, Vector3 direction, Color? color = null, bool doubled = false, float arrowHeadLength = 0.1f, float arrowHeadAngle = 20.0f)
    {
        ...
        {
            //arrow head
            Vector3 right = Quaternion.LookRotation(direction) * Quaternion.Euler(180 + arrowHeadAngle, 0, 0) * new Vector3(0, 0, 1); //Quaternion.Euler(180 + arrowHeadAngle, 0, 0) change to work in other dimensions
